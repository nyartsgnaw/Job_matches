...
/c1/libs/glibc/2.17/lib/x86_64-linux-gnu/ld-2.17.so --library-path /c1/libs/glibc/2.17/lib/x86_64-linux-gnu/:$LD_LIBRARY_PATH:/usr/lib /c1/apps/anaconda/4.3.1/bin/python ./lib/main.py;
